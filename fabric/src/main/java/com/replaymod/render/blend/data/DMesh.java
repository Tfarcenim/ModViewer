   ...
   public CPointer<Mesh> serialize(Serializer serializer) throws IOException {
      return serializer.maybeMajor(this, this.id, Mesh.class, () -> {
         ...
         while(var4.hasNext()) {
            ...
            images.add(material.textures.isEmpty() ? null : ((DMaterial.DMTex)material.textures.get(0)).texture.image.serialize(serializer));
         }
         ...
         return (mesh) -> {
            ...
            CArrayFacade<CPointer<Material>> mat = serializer.writeDataPArray(Material.class, var10002, materials::get);
            mesh.setMat(mat);
