...
public class GuiVideoRenderer extends GuiScreen implements Tickable {
   ...
   public GuiVideoRenderer(VideoRenderer renderer) {
      this.pauseButton = (GuiButton)((GuiButton)((GuiButton)(new GuiButton(this.buttonPanel)).onClick(new Runnable() {
         public void run() {
      ...
      })).addElements((LayoutData)null, new GuiElement[]{this.title, this.imagePanel, this.previewCheckbox, this.renderTime, this.remainingTime, this.progressBar, this.buttonPanel});
