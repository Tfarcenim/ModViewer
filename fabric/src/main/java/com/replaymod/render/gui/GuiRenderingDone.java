...
public class GuiRenderingDone extends GuiScreen {
   ...
   public final GuiLabel infoLine1 = (GuiLabel)(new GuiLabel()).setI18nText("replaymod.gui.renderdone1", new Object[0]);
   public final GuiLabel infoLine2 = (GuiLabel)(new GuiLabel()).setI18nText("replaymod.gui.renderdone2", new Object[0]);
   ...
   public GuiRenderingDone(ReplayModRender mod, File videoFile, int videoFrames, RenderSettings settings) {
      this.actionsPanel = (GuiPanel)((GuiPanel)(new GuiPanel()).setLayout((new VerticalLayout()).setSpacing(10))).addElements((LayoutData)null, new GuiElement[]{this.openFolder});
      this.mainPanel = (GuiPanel)((GuiPanel)(new GuiPanel(this)).setLayout((new VerticalLayout()).setSpacing(10))).addElements(new VerticalLayout.Data(0.5D), new GuiElement[]{((GuiPanel)(new GuiPanel()).setLayout((new VerticalLayout()).setSpacing(4))).addElements((LayoutData)null, new GuiElement[]{this.infoLine1, this.infoLine2}), this.actionsPanel});
      ...
      this.neverOpenCheckbox = (GuiCheckbox)(new GuiCheckbox()).setI18nLabel("replaymod.gui.notagain", new Object[0]);
      this.closePanel = (GuiPanel)((GuiPanel)(new GuiPanel(this)).setLayout((new HorizontalLayout(HorizontalLayout.Alignment.RIGHT)).setSpacing(5))).addElements(new HorizontalLayout.Data(0.5D), new GuiElement[]{this.neverOpenCheckbox, this.closeButton});
