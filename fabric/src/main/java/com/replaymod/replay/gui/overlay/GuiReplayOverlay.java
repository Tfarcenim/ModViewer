...
public class GuiReplayOverlay extends AbstractGuiOverlay<GuiReplayOverlay> {
   ...
   public GuiReplayOverlay(ReplayHandler replayHandler) {
      ...
      this.topPanel = (GuiPanel)(new GuiPanel(this)).setLayout((new HorizontalLayout(HorizontalLayout.Alignment.LEFT)).setSpacing(5));
      ...
      this.speedSlider = (GuiSlider)((GuiSlider)(new GuiSlider()).setSize(100, 20)).setSteps(37);
      this.statusIndicatorPanel = (GuiPanel)((GuiPanel)(new GuiPanel(this)).setSize(100, 16)).setLayout((new HorizontalLayout(HorizontalLayout.Alignment.RIGHT)).setSpacing(5));
      ...
      this.topPanel.addElements((LayoutData)null, new GuiElement[]{this.playPauseButton, this.speedSlider, this.timeline});
      ...
      ((GuiSlider)this.speedSlider.onValueChanged(new Runnable() {
         public void run() {
            ...
            String var10001 = I18n.get("replaymod.gui.speed", new Object[0]);
