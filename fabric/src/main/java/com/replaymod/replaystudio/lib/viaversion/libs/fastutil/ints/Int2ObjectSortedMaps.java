...
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectBidirectionalIterable;
...
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectSortedSets;
...
public final class Int2ObjectSortedMaps {
   ...
   public static <V> Int2ObjectSortedMap<V> synchronize(Int2ObjectSortedMap<V> m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2ObjectSortedMaps.SynchronizedSortedMap(m);
   }

   public static <V> Int2ObjectSortedMap<V> synchronize(Int2ObjectSortedMap<V> m, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2ObjectSortedMaps.SynchronizedSortedMap(m, sync);
   }

   public static <V> Int2ObjectSortedMap<V> unmodifiable(Int2ObjectSortedMap<? extends V> m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2ObjectSortedMaps.UnmodifiableSortedMap(m);
   }
