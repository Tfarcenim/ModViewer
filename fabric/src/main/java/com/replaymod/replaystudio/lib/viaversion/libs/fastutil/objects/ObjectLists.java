...
public final class ObjectLists {
   ...
   public static <K> ObjectList<K> synchronize(ObjectList<K> l) {
      return (ObjectList)(l instanceof RandomAccess ? new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectLists.SynchronizedRandomAccessList(l) : new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectLists.SynchronizedList(l));
   }

   public static <K> ObjectList<K> synchronize(ObjectList<K> l, Object sync) {
      return (ObjectList)(l instanceof RandomAccess ? new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectLists.SynchronizedRandomAccessList(l, sync) : new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectLists.SynchronizedList(l, sync));
   }

   public static <K> ObjectList<K> unmodifiable(ObjectList<? extends K> l) {
      return (ObjectList)(l instanceof RandomAccess ? new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectLists.UnmodifiableRandomAccessList(l) : new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectLists.UnmodifiableList(l));
   }
