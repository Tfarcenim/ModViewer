...
import com.replaymod.replaystudio.lib.viaversion.api.minecraft.entities.Entity1_10Types;
...
import com.replaymod.replaystudio.lib.viaversion.protocols.protocol1_9to1_8.chat.GameMode;
      ...
      if (type != null) {
         ...
         while(true) {
            ...
            do {
               do {
                  ...
                  if (type == Entity1_10Types.EntityType.ARMOR_STAND && Via.getConfig().isHologramPatch() && metadata.id() == 0 && this.getMetaByIndex(metadataList, 10) != null) {
                     ...
                     if ((data & 32) == 32 && ((Byte)meta.getValue() & 1) == 1 && (displayName = this.getMetaByIndex(metadataList, 2)) != null && !Strings.isNullOrEmpty((String)displayName.getValue()) && (displayNameVisible = this.getMetaByIndex(metadataList, 3)) != null && displayNameVisible.getValue() == Boolean.TRUE && !this.knownHolograms.contains(entityId)) {
            ...
            if (metadata.id() == 2) {
               ...
               if (bar == null) {
                  String title = type == Entity1_10Types.EntityType.ENDER_DRAGON ? "{\"translate\":\"entity.EnderDragon.name\"}" : "{\"translate\":\"entity.WitherBoss.name\"}";
