...
public final class ObjectSets {
   ...
   public static <K> ObjectSet<K> synchronize(ObjectSet<K> s) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectSets.SynchronizedSet(s);
   }

   public static <K> ObjectSet<K> synchronize(ObjectSet<K> s, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectSets.SynchronizedSet(s, sync);
   }

   public static <K> ObjectSet<K> unmodifiable(ObjectSet<? extends K> s) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectSets.UnmodifiableSet(s);
   }
