...
final class GwtWorkarounds {
   ...
   static GwtWorkarounds.CharInput asCharInput(Reader reader) {
   ...
   static GwtWorkarounds.CharInput asCharInput(CharSequence chars) {
   ...
   static InputStream asInputStream(GwtWorkarounds.ByteInput input) {
   ...
   static OutputStream asOutputStream(GwtWorkarounds.ByteOutput output) {
   ...
   static GwtWorkarounds.CharOutput asCharOutput(Writer writer) {
