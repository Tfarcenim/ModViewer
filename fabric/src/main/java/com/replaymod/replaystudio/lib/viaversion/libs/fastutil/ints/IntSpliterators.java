...
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.SafeMath;
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.bytes.ByteSpliterator;
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.chars.CharSpliterator;
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.shorts.ShortSpliterator;
...
public final class IntSpliterators {
   ...
   public static IntSpliterator wrap(ByteSpliterator spliterator) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSpliterators.ByteSpliteratorWrapper(spliterator);
   }

   public static IntSpliterator wrap(ShortSpliterator spliterator) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSpliterators.ShortSpliteratorWrapper(spliterator);
   }

   public static IntSpliterator wrap(CharSpliterator spliterator) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSpliterators.CharSpliteratorWrapper(spliterator);
   }
