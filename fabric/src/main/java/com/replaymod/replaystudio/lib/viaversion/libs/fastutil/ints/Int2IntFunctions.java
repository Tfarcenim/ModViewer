...
public final class Int2IntFunctions {
   ...
   public static Int2IntFunction synchronize(Int2IntFunction f) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2IntFunctions.SynchronizedFunction(f);
   }

   public static Int2IntFunction synchronize(Int2IntFunction f, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2IntFunctions.SynchronizedFunction(f, sync);
   }

   public static Int2IntFunction unmodifiable(Int2IntFunction f) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2IntFunctions.UnmodifiableFunction(f);
   }
