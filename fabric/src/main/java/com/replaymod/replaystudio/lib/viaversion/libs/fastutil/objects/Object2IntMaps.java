...
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSets;
...
public final class Object2IntMaps {
   ...
   public static <K> Object2IntMap<K> synchronize(Object2IntMap<K> m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2IntMaps.SynchronizedMap(m);
   }

   public static <K> Object2IntMap<K> synchronize(Object2IntMap<K> m, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2IntMaps.SynchronizedMap(m, sync);
   }

   public static <K> Object2IntMap<K> unmodifiable(Object2IntMap<? extends K> m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2IntMaps.UnmodifiableMap(m);
   }
