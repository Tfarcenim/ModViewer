package com.replaymod.replaystudio.lib.guava.primitives;
...
import com.replaymod.replaystudio.lib.guava.base.Converter;
      ...
      if (((String)Preconditions.checkNotNull(string)).isEmpty()) {
         ...
         if (index == string.length()) {
            ...
            if (digit >= 0 && digit < radix) {
               ...
               for(int cap = Integer.MIN_VALUE / radix; index < string.length(); accum -= digit) {
