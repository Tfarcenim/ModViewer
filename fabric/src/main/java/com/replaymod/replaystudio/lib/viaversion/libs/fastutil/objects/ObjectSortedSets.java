...
public final class ObjectSortedSets {
   ...
   public static <K> ObjectSortedSet<K> synchronize(ObjectSortedSet<K> s) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectSortedSets.SynchronizedSortedSet(s);
   }

   public static <K> ObjectSortedSet<K> synchronize(ObjectSortedSet<K> s, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectSortedSets.SynchronizedSortedSet(s, sync);
   }

   public static <K> ObjectSortedSet<K> unmodifiable(ObjectSortedSet<K> s) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectSortedSets.UnmodifiableSortedSet(s);
   }
