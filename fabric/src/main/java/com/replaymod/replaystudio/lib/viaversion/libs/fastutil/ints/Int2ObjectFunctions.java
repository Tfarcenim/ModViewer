...
public final class Int2ObjectFunctions {
   ...
   public static <V> Int2ObjectFunction<V> synchronize(Int2ObjectFunction<V> f) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2ObjectFunctions.SynchronizedFunction(f);
   }

   public static <V> Int2ObjectFunction<V> synchronize(Int2ObjectFunction<V> f, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2ObjectFunctions.SynchronizedFunction(f, sync);
   }

   public static <V> Int2ObjectFunction<V> unmodifiable(Int2ObjectFunction<? extends V> f) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2ObjectFunctions.UnmodifiableFunction(f);
   }
