...
public final class Object2ObjectFunctions {
   ...
   public static <K, V> Object2ObjectFunction<K, V> synchronize(Object2ObjectFunction<K, V> f) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2ObjectFunctions.SynchronizedFunction(f);
   }

   public static <K, V> Object2ObjectFunction<K, V> synchronize(Object2ObjectFunction<K, V> f, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2ObjectFunctions.SynchronizedFunction(f, sync);
   }

   public static <K, V> Object2ObjectFunction<K, V> unmodifiable(Object2ObjectFunction<? extends K, ? extends V> f) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2ObjectFunctions.UnmodifiableFunction(f);
   }
