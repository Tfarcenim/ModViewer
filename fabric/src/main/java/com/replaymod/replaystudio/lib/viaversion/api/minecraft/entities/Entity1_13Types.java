...
public class Entity1_13Types {
   ...
   public static enum ObjectType implements com.replaymod.replaystudio.lib.viaversion.api.minecraft.entities.ObjectType {
      ...
      private static final Map<Integer, Entity1_13Types.ObjectType> TYPES = new HashMap();
      ...
      public static Optional<Entity1_13Types.EntityType> getPCEntity(int id) {
         Optional<Entity1_13Types.ObjectType> output = findById(id);
   ...
   public static enum EntityType implements com.replaymod.replaystudio.lib.viaversion.api.minecraft.entities.EntityType {
      ...
      private static final Map<Integer, Entity1_13Types.EntityType> TYPES = new HashMap();
      private final int id;
      ...
      public static Optional<Entity1_13Types.EntityType> findById(int id) {
         return id == -1 ? Optional.empty() : Optional.ofNullable(TYPES.get(id));
      }
