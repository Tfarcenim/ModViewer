...
public final class Object2IntFunctions {
   ...
   public static <K> Object2IntFunction<K> synchronize(Object2IntFunction<K> f) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2IntFunctions.SynchronizedFunction(f);
   }

   public static <K> Object2IntFunction<K> synchronize(Object2IntFunction<K> f, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2IntFunctions.SynchronizedFunction(f, sync);
   }

   public static <K> Object2IntFunction<K> unmodifiable(Object2IntFunction<? extends K> f) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2IntFunctions.UnmodifiableFunction(f);
   }
   ...
   public static class EmptyFunction<K> extends AbstractObject2IntFunction<K> implements Serializable, Cloneable {
      ...
      public boolean equals(Object o) {
         if (!(o instanceof com.replaymod.replaystudio.lib.viaversion.libs.fastutil.Function)) {
            return false;
         } else {
            return ((com.replaymod.replaystudio.lib.viaversion.libs.fastutil.Function)o).size() == 0;
         }
      }
