...
public final class IntCollections {
   ...
   public static IntCollection synchronize(IntCollection c) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntCollections.SynchronizedCollection(c);
   }

   public static IntCollection synchronize(IntCollection c, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntCollections.SynchronizedCollection(c, sync);
   }

   public static IntCollection unmodifiable(IntCollection c) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntCollections.UnmodifiableCollection(c);
   }
