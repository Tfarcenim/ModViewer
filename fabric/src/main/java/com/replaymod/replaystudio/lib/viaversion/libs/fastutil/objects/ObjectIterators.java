...
public final class ObjectIterators {
   ...
   public static <K> ObjectIterator<K> unmodifiable(ObjectIterator<? extends K> i) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectIterators.UnmodifiableIterator(i);
   }

   public static <K> ObjectBidirectionalIterator<K> unmodifiable(ObjectBidirectionalIterator<? extends K> i) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectIterators.UnmodifiableBidirectionalIterator(i);
   }

   public static <K> ObjectListIterator<K> unmodifiable(ObjectListIterator<? extends K> i) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectIterators.UnmodifiableListIterator(i);
   }
