...
public final class IntLists {
   ...
   public static IntList synchronize(IntList l) {
      return (IntList)(l instanceof RandomAccess ? new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntLists.SynchronizedRandomAccessList(l) : new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntLists.SynchronizedList(l));
   }

   public static IntList synchronize(IntList l, Object sync) {
      return (IntList)(l instanceof RandomAccess ? new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntLists.SynchronizedRandomAccessList(l, sync) : new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntLists.SynchronizedList(l, sync));
   }

   public static IntList unmodifiable(IntList l) {
      return (IntList)(l instanceof RandomAccess ? new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntLists.UnmodifiableRandomAccessList(l) : new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntLists.UnmodifiableList(l));
   }
