...
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectIterable;
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectIterator;
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectSet;
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectSets;
...
public final class Int2ObjectMaps {
   ...
   public static <V> Int2ObjectMap<V> synchronize(Int2ObjectMap<V> m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2ObjectMaps.SynchronizedMap(m);
   }

   public static <V> Int2ObjectMap<V> synchronize(Int2ObjectMap<V> m, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2ObjectMaps.SynchronizedMap(m, sync);
   }

   public static <V> Int2ObjectMap<V> unmodifiable(Int2ObjectMap<? extends V> m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2ObjectMaps.UnmodifiableMap(m);
   }
