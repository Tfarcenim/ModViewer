...
public final class IntSets {
   ...
   public static IntSet synchronize(IntSet s) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSets.SynchronizedSet(s);
   }

   public static IntSet synchronize(IntSet s, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSets.SynchronizedSet(s, sync);
   }

   public static IntSet unmodifiable(IntSet s) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSets.UnmodifiableSet(s);
   }
