...
public final class ObjectCollections {
   ...
   public static <K> ObjectCollection<K> synchronize(ObjectCollection<K> c) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectCollections.SynchronizedCollection(c);
   }

   public static <K> ObjectCollection<K> synchronize(ObjectCollection<K> c, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectCollections.SynchronizedCollection(c, sync);
   }

   public static <K> ObjectCollection<K> unmodifiable(ObjectCollection<? extends K> c) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.ObjectCollections.UnmodifiableCollection(c);
   }
