...
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.bytes.ByteIterator;
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.chars.CharIterator;
import com.replaymod.replaystudio.lib.viaversion.libs.fastutil.shorts.ShortIterator;
...
public final class IntIterators {
   ...
   public static IntIterator unmodifiable(IntIterator i) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntIterators.UnmodifiableIterator(i);
   }

   public static IntBidirectionalIterator unmodifiable(IntBidirectionalIterator i) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntIterators.UnmodifiableBidirectionalIterator(i);
   }

   public static IntListIterator unmodifiable(IntListIterator i) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntIterators.UnmodifiableListIterator(i);
   }

   public static IntIterator wrap(ByteIterator iterator) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntIterators.ByteIteratorWrapper(iterator);
   }

   public static IntIterator wrap(ShortIterator iterator) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntIterators.ShortIteratorWrapper(iterator);
   }

   public static IntIterator wrap(CharIterator iterator) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntIterators.CharIteratorWrapper(iterator);
   }
