...
import com.replaymod.replaystudio.lib.viaversion.protocols.protocol1_19_1to1_19.Protocol1_19_1To1_19;
...
public class ProtocolManagerImpl implements ProtocolManager {
   ...
   public boolean checkForMappingCompletion() {
      ...
      try {
         if (!this.mappingsLoaded) {
            Iterator var7 = this.mappingLoaderFutures.values().iterator();
            ...
            do {
               ...
               future = (CompletableFuture)var7.next();
            } while(future.isDone());
