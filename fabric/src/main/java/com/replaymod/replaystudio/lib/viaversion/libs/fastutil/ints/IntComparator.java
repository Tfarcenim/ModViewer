...
public interface IntComparator extends Comparator<Integer> {
   ...
   private static Object $deserializeLambda$(SerializedLambda lambda) {
      ...
      default:
         switch(var2) {
         case 0:
            if (lambda.getImplMethodKind() == 7 && lambda.getFunctionalInterfaceClass().equals("com/replaymod/replaystudio/lib/viaversion/libs/fastutil/ints/IntComparator") && lambda.getFunctionalInterfaceMethodName().equals("compare") && lambda.getFunctionalInterfaceMethodSignature().equals("(II)I") && lambda.getImplClass().equals("com/replaymod/replaystudio/lib/viaversion/libs/fastutil/ints/IntComparator") && lambda.getImplMethodSignature().equals("(Lit/unimi/dsi/fastutil/ints/IntComparator;II)I")) {
