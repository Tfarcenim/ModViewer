...
public final class IntSortedSets {
   ...
   public static IntSortedSet synchronize(IntSortedSet s) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSortedSets.SynchronizedSortedSet(s);
   }

   public static IntSortedSet synchronize(IntSortedSet s, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSortedSets.SynchronizedSortedSet(s, sync);
   }

   public static IntSortedSet unmodifiable(IntSortedSet s) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.IntSortedSets.UnmodifiableSortedSet(s);
   }
