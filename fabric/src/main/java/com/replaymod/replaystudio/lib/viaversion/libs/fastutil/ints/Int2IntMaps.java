...
public final class Int2IntMaps {
   ...
   public static Int2IntMap synchronize(Int2IntMap m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2IntMaps.SynchronizedMap(m);
   }

   public static Int2IntMap synchronize(Int2IntMap m, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2IntMaps.SynchronizedMap(m, sync);
   }

   public static Int2IntMap unmodifiable(Int2IntMap m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.ints.Int2IntMaps.UnmodifiableMap(m);
   }
