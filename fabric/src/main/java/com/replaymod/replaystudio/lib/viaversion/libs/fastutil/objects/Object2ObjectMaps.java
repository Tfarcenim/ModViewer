...
public final class Object2ObjectMaps {
   ...
   public static <K, V> Object2ObjectMap<K, V> synchronize(Object2ObjectMap<K, V> m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2ObjectMaps.SynchronizedMap(m);
   }

   public static <K, V> Object2ObjectMap<K, V> synchronize(Object2ObjectMap<K, V> m, Object sync) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2ObjectMaps.SynchronizedMap(m, sync);
   }

   public static <K, V> Object2ObjectMap<K, V> unmodifiable(Object2ObjectMap<? extends K, ? extends V> m) {
      return new com.replaymod.replaystudio.lib.viaversion.libs.fastutil.objects.Object2ObjectMaps.UnmodifiableMap(m);
   }
