   ...
   public boolean equals(Object o) {
      if (this == o) {
         ...
         if (this.time != marker.time) {
            return false;
         } else if (Double.compare(marker.x, this.x) != 0) {
            return false;
         } else if (Double.compare(marker.y, this.y) != 0) {
            return false;
         } else if (Double.compare(marker.z, this.z) != 0) {
            return false;
         } else if (Float.compare(marker.yaw, this.yaw) != 0) {
            return false;
         } else if (Float.compare(marker.pitch, this.pitch) != 0) {
            return false;
         } else if (Float.compare(marker.roll, this.roll) != 0) {
            return false;
         } else {
            boolean var10000;
            label69: {
