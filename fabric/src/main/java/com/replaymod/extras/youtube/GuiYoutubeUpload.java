...
public class GuiYoutubeUpload extends GuiScreen {
      ...
      public void run() {
         ...
         if (GuiYoutubeUpload.this.upload == null) {
            if (problem == null) {
               ...
               GuiYoutubeUpload.this.uploadButton.setTooltip((new GuiTooltip()).setI18nText(problem, new Object[0]));
            }
         }

      }
   };
   public final GuiTextField nameField = (GuiTextField)((GuiTextField)(new GuiTextField()).setI18nHint("replaymod.gui.videotitle", new Object[0])).onTextChanged((s) -> {
      this.inputValidation.run();
   });
   public final GuiTextArea descriptionField = (GuiTextArea)((GuiTextArea)((GuiTextArea)(new GuiTextArea()).setMaxCharCount(Integer.MAX_VALUE)).setMaxTextWidth(Integer.MAX_VALUE)).setMaxTextHeight(Integer.MAX_VALUE);
   ...
   public GuiYoutubeUpload(GuiScreen previousScreen, File videoFile, int videoFrames, RenderSettings settings) {
      ...
      ((GuiTextField)this.nameField.setNext(this.descriptionField)).getNext().setNext(this.tagsField).getNext().setNext(this.nameField);
      ...
      })).addElements((LayoutData)null, new GuiElement[]{this.nameField, this.descriptionField, this.tagsField, this.progressBar});
      this.visibilityDropdown = (GuiDropdownMenu)((GuiDropdownMenu)((GuiDropdownMenu)(new GuiDropdownMenu()).setSize(200, 20)).setValues(VideoVisibility.values())).setSelected(VideoVisibility.PUBLIC);
         ...
         public void run() {
            GuiFileChooserPopup.openLoadGui(GuiYoutubeUpload.this, "replaymod.gui.load", ImageIO.getReaderFileSuffixes()).onAccept((file) -> {
               ...
               try {
                  ...
                  image = Image.read((InputStream)(new ByteArrayInputStream(GuiYoutubeUpload.this.thumbnailImage)));
      ...
      this.rightPanel = (GuiPanel)((GuiPanel)(new GuiPanel(this)).addElements((LayoutData)null, new GuiElement[]{this.visibilityDropdown, this.thumbnailButton, this.thumbnail})).setLayout((new VerticalLayout(VerticalLayout.Alignment.TOP)).setSpacing(10));
            ...
            try {
               ...
               Futures.addCallback(future, new FutureCallback<Video>() {
                  public void onSuccess(Video result) {
                     ...
                     GuiYoutubeUpload.this.progressBar.setLabel(I18n.get("replaymod.gui.ytuploadprogress.done", new Object[]{url}));
