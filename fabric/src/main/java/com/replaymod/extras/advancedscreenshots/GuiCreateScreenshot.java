...
public class GuiCreateScreenshot extends GuiRenderSettings implements Loadable {
   ...
   public GuiCreateScreenshot(ReplayMod mod) {
      ...
      this.mod = mod;
      ((GuiPanel)this.resetChildren(this.settingsList.getListPanel())).addElements(new VerticalLayout.Data(0.5D), new GuiElement[]{(new GuiLabel()).setI18nText("replaymod.gui.advancedscreenshots.title", new Object[0]), this.mainPanel, new GuiPanel(), (new GuiLabel()).setI18nText("replaymod.gui.rendersettings.advanced", new Object[0]), this.advancedPanel, new GuiPanel()});
      ((GuiPanel)this.resetChildren(this.mainPanel)).addElements(new GridLayout.Data(1.0D, 0.5D), new GuiElement[]{(new GuiLabel()).setI18nText("replaymod.gui.rendersettings.renderer", new Object[0]), this.renderMethodDropdown, (new GuiLabel()).setI18nText("replaymod.gui.advancedscreenshots.resolution", new Object[0]), this.videoResolutionPanel, (new GuiLabel()).setI18nText("replaymod.gui.rendersettings.outputfile", new Object[0]), this.outputFileButton});
      ((GuiPanel)this.resetChildren(this.advancedPanel)).addElements((LayoutData)null, new GuiElement[]{this.nametagCheckbox, this.alphaCheckbox, ((GuiPanel)(new GuiPanel()).setLayout((new GridLayout()).setCellsEqualSize(false).setColumns(2).setSpacingX(5).setSpacingY(15))).addElements(new GridLayout.Data(0.0D, 0.5D), new GuiElement[]{(new GuiLabel()).setI18nText("replaymod.gui.rendersettings.stabilizecamera", new Object[0]), this.stabilizePanel, this.chromaKeyingCheckbox, this.chromaKeyingColor})});
   ...
   private <T extends GuiContainer<?>> T resetChildren(T container) {
      ArrayList var10000 = new ArrayList(container.getChildren());
