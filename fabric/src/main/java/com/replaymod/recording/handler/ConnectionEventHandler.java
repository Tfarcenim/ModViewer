...
public class ConnectionEventHandler {
   ...
   public void onConnectedToServerEvent(Connection networkManager) {
      try {
         ...
         ServerData var10000;
         if (var5 instanceof ClientLoginNetworkHandlerAccessor) {
            ClientLoginNetworkHandlerAccessor loginNetworkHandler = (ClientLoginNetworkHandlerAccessor)var5;
            var10000 = loginNetworkHandler.getServerInfo();
         } else {
            var10000 = null;
         }
