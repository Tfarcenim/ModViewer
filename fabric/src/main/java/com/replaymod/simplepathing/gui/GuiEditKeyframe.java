...
public abstract class GuiEditKeyframe<T extends GuiEditKeyframe<T>> extends AbstractGuiPopup<T> implements Typeable {
   ...
   public GuiEditKeyframe(GuiPathing gui, SPTimeline.SPPath path, long time, String type) {
      ...
      this.timePanel = (GuiPanel)((GuiPanel)(new GuiPanel()).setLayout((new HorizontalLayout(HorizontalLayout.Alignment.RIGHT)).setSpacing(3))).addElements(new HorizontalLayout.Data(0.5D), new GuiElement[]{(new GuiLabel()).setI18nText("replaymod.gui.editkeyframe.timelineposition", new Object[0]), this.timeMinField, (new GuiLabel()).setI18nText("replaymod.gui.minutes", new Object[0]), this.timeSecField, (new GuiLabel()).setI18nText("replaymod.gui.seconds", new Object[0]), this.timeMSecField, (new GuiLabel()).setI18nText("replaymod.gui.milliseconds", new Object[0])});
      this.saveButton = (GuiButton)((GuiButton)(new GuiButton()).setSize(150, 20)).setI18nLabel("replaymod.gui.save", new Object[0]);
      ...
      ((GuiPanel)this.popup.setLayout((new VerticalLayout()).setSpacing(10))).addElements(new VerticalLayout.Data(0.5D, false), new GuiElement[]{this.title, this.inputs, this.timePanel, this.buttons});
      this.guiPathing = gui;
      this.time = time;
      ...
      ((GuiNumberField)this.timeMinField.setValue((double)(time / 1000L / 60L))).onTextChanged(updateSaveButtonState);
      ((GuiNumberField)this.timeSecField.setValue((double)(time / 1000L % 60L))).onTextChanged(updateSaveButtonState);
      ...
      this.saveButton.onClick(() -> {
         ...
         long newTime = (long)((this.timeMinField.getInteger() * 60 + this.timeSecField.getInteger()) * 1000 + this.timeMSecField.getInteger());
         if (newTime != time) {
            change = CombinedChange.createFromApplied((Change)change, gui.getMod().getCurrentTimeline().moveKeyframe(path, time, newTime));
   ...
   public static class Position extends GuiEditKeyframe<GuiEditKeyframe.Position> {
      ...
      public Position(GuiPathing gui, SPTimeline.SPPath path, long keyframe) {
         ...
         GuiPanel positionInputs = (GuiPanel)((GuiPanel)(new GuiPanel()).setLayout((new GridLayout()).setCellsEqualSize(false).setColumns(4).setSpacingX(3).setSpacingY(5))).addElements(new GridLayout.Data(1.0D, 0.5D), new GuiElement[]{(new GuiLabel()).setI18nText("replaymod.gui.editkeyframe.xpos", new Object[0]), this.xField, (new GuiLabel()).setI18nText("replaymod.gui.editkeyframe.camyaw", new Object[0]), this.yawField, (new GuiLabel()).setI18nText("replaymod.gui.editkeyframe.ypos", new Object[0]), this.yField, (new GuiLabel()).setI18nText("replaymod.gui.editkeyframe.campitch", new Object[0]), this.pitchField, (new GuiLabel()).setI18nText("replaymod.gui.editkeyframe.zpos", new Object[0]), this.zField, (new GuiLabel()).setI18nText("replaymod.gui.editkeyframe.camroll", new Object[0]), this.rollField});
         ((GuiPanel)this.inputs.setLayout((new VerticalLayout()).setSpacing(10))).addElements(new VerticalLayout.Data(0.5D, false), new GuiElement[]{positionInputs, this.interpolationPanel});
      ...
      public class InterpolationPanel extends AbstractGuiContainer<GuiEditKeyframe.Position.InterpolationPanel> {
         ...
         public InterpolationPanel() {
            ...
            this.dropdown = (GuiDropdownMenu)((GuiDropdownMenu)((GuiDropdownMenu)((GuiDropdownMenu)(new GuiDropdownMenu()).setToString((s) -> {
               return I18n.get(s.getI18nName(), new Object[0]);
            ...
            while(var2.hasNext()) {
               ...
               ((IGuiClickable)e.getValue()).setTooltip((new GuiTooltip()).setI18nText(((InterpolatorType)e.getKey()).getI18nDescription(), new Object[0]));
            }

            GuiPanel dropdownPanel = (GuiPanel)((GuiPanel)(new GuiPanel()).setLayout((new GridLayout()).setCellsEqualSize(false).setColumns(2).setSpacingX(3).setSpacingY(5))).addElements(new GridLayout.Data(1.0D, 0.5D), new GuiElement[]{(new GuiLabel()).setI18nText("replaymod.gui.editkeyframe.interpolator", new Object[0]), this.dropdown});
         ...
         protected InterpolatorType getInterpolatorTypeNoDefault(InterpolatorType interpolatorType) {
            if (interpolatorType != InterpolatorType.DEFAULT && interpolatorType != null) {
               ...
               InterpolatorType defaultType = InterpolatorType.fromString((String)Position.this.guiPathing.getMod().getCore().getSettingsRegistry().get(Setting.DEFAULT_INTERPOLATION));
               return defaultType;
            }
         }
         ...
         public class CatmullRomSettingsPanel extends GuiEditKeyframe.Position.InterpolationPanel.SettingsPanel<CatmullRomSplineInterpolator, GuiEditKeyframe.Position.InterpolationPanel.CatmullRomSettingsPanel> {
            ...
            public CatmullRomSettingsPanel() {
               super();
               this.alphaLabel = (GuiLabel)((GuiLabel)(new GuiLabel()).setColor(Colors.BLACK)).setI18nText("replaymod.gui.editkeyframe.interpolator.catmullrom.alpha", new Object[0]);
               this.alphaField = (GuiNumberField)((GuiNumberField)((GuiNumberField)((GuiNumberField)(new GuiNumberField()).setSize(100, 20)).setPrecision(5)).setMinValue(0)).setValidateOnFocusChange(true);
               this.setLayout(new HorizontalLayout(HorizontalLayout.Alignment.CENTER));
               this.addElements(new HorizontalLayout.Data(0.5D), new GuiElement[]{this.alphaLabel, this.alphaField});
            }
   ...
   public static class Time extends GuiEditKeyframe<GuiEditKeyframe.Time> {
      ...
      public Time(GuiPathing gui, SPTimeline.SPPath path, long keyframe) {
         ...
         ((GuiPanel)this.inputs.setLayout((new HorizontalLayout(HorizontalLayout.Alignment.RIGHT)).setSpacing(3))).addElements(new HorizontalLayout.Data(0.5D), new GuiElement[]{(new GuiLabel()).setI18nText("replaymod.gui.editkeyframe.timestamp", new Object[0]), this.timestampMinField, (new GuiLabel()).setI18nText("replaymod.gui.minutes", new Object[0]), this.timestampSecField, (new GuiLabel()).setI18nText("replaymod.gui.seconds", new Object[0]), this.timestampMSecField, (new GuiLabel()).setI18nText("replaymod.gui.milliseconds", new Object[0])});
