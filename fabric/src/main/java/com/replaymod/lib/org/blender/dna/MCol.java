...
public class MCol extends CFacade {
   ...
   public static final long[] __DNA__FIELD__a = new long[]{0L, 0L};
   public static final long[] __DNA__FIELD__r = new long[]{1L, 1L};
   public static final long[] __DNA__FIELD__g = new long[]{2L, 2L};
   public static final long[] __DNA__FIELD__b = new long[]{3L, 3L};
   ...
   public void setA(byte a) throws IOException {
      if (this.__io__pointersize == 8) {
         this.__io__block.writeByte(this.__io__address + 0L, a);
      } else {
         this.__io__block.writeByte(this.__io__address + 0L, a);
      }
   ...
   public void setR(byte r) throws IOException {
      if (this.__io__pointersize == 8) {
         this.__io__block.writeByte(this.__io__address + 1L, r);
      } else {
         this.__io__block.writeByte(this.__io__address + 1L, r);
      }
   ...
   public void setG(byte g) throws IOException {
      if (this.__io__pointersize == 8) {
         this.__io__block.writeByte(this.__io__address + 2L, g);
      } else {
         this.__io__block.writeByte(this.__io__address + 2L, g);
      }
   ...
   public void setB(byte b) throws IOException {
      if (this.__io__pointersize == 8) {
         this.__io__block.writeByte(this.__io__address + 3L, b);
      } else {
         this.__io__block.writeByte(this.__io__address + 3L, b);
      }
   ...
   public CPointer<MCol> __io__addressof() {
      return new CPointer(this.__io__address, new Class[]{MCol.class}, this.__io__block, this.__io__blockTable);
   }
}
