...
public class ListBase extends CFacade {
   ...
   public static final long[] __DNA__FIELD__first = new long[]{0L, 0L};
   public static final long[] __DNA__FIELD__last = new long[]{4L, 8L};
   ...
   public void setFirst(CPointer<Object> first) throws IOException {
      long __address = first == null ? 0L : first.getAddress();
      if (this.__io__pointersize == 8) {
   ...
   public void setLast(CPointer<Object> last) throws IOException {
      long __address = last == null ? 0L : last.getAddress();
      if (this.__io__pointersize == 8) {
   ...
   public CPointer<ListBase> __io__addressof() {
      return new CPointer(this.__io__address, new Class[]{ListBase.class}, this.__io__block, this.__io__blockTable);
   }
}
