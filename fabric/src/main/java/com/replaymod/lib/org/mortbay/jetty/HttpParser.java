...
public class HttpParser implements Parser {
   ...
   private HttpParser.Input _input;
               ...
               if (filled < 0) {
                  if (this._state == 1) {
                     if (this._buffer.length() > 0) {
                        chunk = this._buffer.get(this._buffer.length());
               ...
               if (this._eol == 13 && ch == 10) {
                  ...
                  case -10:
                     if (ch == 32) {
                        ...
                        this._handler.startRequest(HttpMethods.CACHE.lookup((Buffer)this._tok0), this._buffer.sliceFromMark(), (Buffer)null);
                        this._state = 0;
                  ...
                  case -9:
                     if (ch <= 32 && ch >= 0) {
                        if (ch < 32) {
                           this._handler.startRequest(HttpMethods.CACHE.lookup((Buffer)this._tok0), this._tok1, (Buffer)null);
                           this._state = 0;
                           this._handler.headerComplete();
                           this._handler.messageComplete(this._contentPosition);
                           return total_filled;
                  ...
                  case -6:
                     ...
                     chunk = HttpMethods.CACHE.lookup((Buffer)this._tok0);
                     if (chunk == this._tok0 && this._tok1.length() == 3 && Character.isDigit((char)this._tok1.peek())) {
                        this._responseStatus = BufferUtil.toInt(this._tok1);
                        this._handler.startResponse(HttpVersions.CACHE.lookup((Buffer)this._tok0), this._responseStatus, this._buffer.sliceFromMark());
                     } else {
                        this._handler.startRequest(chunk, this._tok1, HttpVersions.CACHE.lookup(this._buffer.sliceFromMark()));
                     }
                  ...
                  case -5:
                     ...
                     default:
                        if (this._cached != null || this._tok0.length() > 0 || this._tok1.length() > 0 || this._multiLineValue != null) {
                           Buffer header = this._cached != null ? this._cached : HttpHeaders.CACHE.lookup(this._tok0);
                           this._cached = null;
      ...
      if (space == 0) {
         ...
         if (this._endp != null) {
            try {
               ...
               this.reset(true);
               throw var4 instanceof EofException ? var4 : new EofException(var4);
            }
         }
   ...
   public static class Input extends ServletInputStream {
      ...
      private boolean blockForContent() throws IOException {
         if (this._content.length() > 0) {
            return true;
         } else if (this._parser.getState() <= 0) {
            return false;
         } else {
            if (this._endp == null) {
               ...
               while(true) {
                  do {
                     if (this._content.length() != 0 || this._parser.isState(0) || !this._endp.isOpen()) {
                        return this._content.length() > 0;
                     }
                  } while(this._endp.isBufferingInput() && this._parser.parseNext() > 0L);
