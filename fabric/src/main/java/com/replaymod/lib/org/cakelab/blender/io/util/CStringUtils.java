...
public class CStringUtils {
   ...
   public static String readNullTerminatedString(CDataReadWriteAccess in, boolean removeControlCodes) throws IOException {
      ...
      for(byte b = in.readByte(); b != 0; b = in.readByte()) {
         buffer[len] = b;
         ++len;
         if (len >= capacity) {
            capacity <<= 1;
   ...
   public static void writeNullTerminatedString(String string, Charset charset, CDataReadWriteAccess io, boolean b) throws IOException {
