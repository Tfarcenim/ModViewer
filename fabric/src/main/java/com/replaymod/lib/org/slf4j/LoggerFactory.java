package com.replaymod.lib.org.slf4j;

import com.replaymod.lib.org.slf4j.event.SubstituteLoggingEvent;
import com.replaymod.lib.org.slf4j.helpers.NOPLoggerFactory;
import com.replaymod.lib.org.slf4j.helpers.SubstituteLogger;
import com.replaymod.lib.org.slf4j.helpers.SubstituteLoggerFactory;
import com.replaymod.lib.org.slf4j.helpers.Util;
import com.replaymod.lib.org.slf4j.impl.StaticLoggerBinder;
...
public final class LoggerFactory {
   ...
   private static String STATIC_LOGGER_BINDER_PATH = "com/replaymod/lib/org/slf4j/impl/StaticLoggerBinder.class";
   ...
   private static boolean messageContainsOrgSlf4jImplStaticLoggerBinder(String msg) {
      if (msg == null) {
         return false;
      } else if (msg.contains("com/replaymod/lib/org/slf4j/impl/StaticLoggerBinder")) {
         return true;
      } else {
         return msg.contains("com.replaymod.lib.org.slf4j.impl.StaticLoggerBinder");
      }
   }
   ...
   private static final void bind() {
      try {
         ...
         try {
            ...
            msg = var8.getMessage();
            if (msg != null && msg.contains("com.replaymod.lib.org.slf4j.impl.StaticLoggerBinder.getSingleton()")) {
