...
public class HttpHeaders extends BufferCache {
   ...
   static {
      ...
      SERVLET_ENGINE_BUFFER = CACHE.add("Servlet-Engine", 49);
      ...
      SET_COOKIE2_BUFFER = CACHE.add("Set-Cookie2", 54);
      MIME_VERSION_BUFFER = CACHE.add("MIME-Version", 55);
      IDENTITY_BUFFER = CACHE.add("identity", 56);
      PROXY_CONNECTION_BUFFER = CACHE.add("Proxy-Connection", 58);
   }
}
