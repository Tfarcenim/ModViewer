...
public class rcti extends CFacade {
   ...
   public void setXmin(int xmin) throws IOException {
      if (this.__io__pointersize == 8) {
         this.__io__block.writeInt(this.__io__address + 0L, xmin);
      } else {
         this.__io__block.writeInt(this.__io__address + 0L, xmin);
      }
   ...
   public void setXmax(int xmax) throws IOException {
      if (this.__io__pointersize == 8) {
         this.__io__block.writeInt(this.__io__address + 4L, xmax);
      } else {
         this.__io__block.writeInt(this.__io__address + 4L, xmax);
      }
   ...
   public void setYmin(int ymin) throws IOException {
      if (this.__io__pointersize == 8) {
         this.__io__block.writeInt(this.__io__address + 8L, ymin);
      } else {
         this.__io__block.writeInt(this.__io__address + 8L, ymin);
      }
   ...
   public void setYmax(int ymax) throws IOException {
      if (this.__io__pointersize == 8) {
         this.__io__block.writeInt(this.__io__address + 12L, ymax);
      } else {
         this.__io__block.writeInt(this.__io__address + 12L, ymax);
      }
   ...
   public CPointer<rcti> __io__addressof() {
      return new CPointer(this.__io__address, new Class[]{rcti.class}, this.__io__block, this.__io__blockTable);
   }
}
