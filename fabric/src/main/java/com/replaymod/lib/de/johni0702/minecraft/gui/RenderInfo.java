...
public class RenderInfo {
   ...
   public void addTo(CrashReport crashReport) {
      ...
      MCVer.addDetail(category, "Partial Tick", () -> {
         return this.partialTick.makeConcatWithConstants<invokedynamic>(this.partialTick);
      });
      MCVer.addDetail(category, "Mouse X", () -> {
         return this.mouseX.makeConcatWithConstants<invokedynamic>(this.mouseX);
      });
      MCVer.addDetail(category, "Mouse Y", () -> {
         return this.mouseY.makeConcatWithConstants<invokedynamic>(this.mouseY);
      });
      MCVer.addDetail(category, "Layer", () -> {
         return this.layer.makeConcatWithConstants<invokedynamic>(this.layer);
      });
   }
