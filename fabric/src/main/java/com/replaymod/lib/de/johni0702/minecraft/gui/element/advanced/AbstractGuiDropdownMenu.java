...
public abstract class AbstractGuiDropdownMenu<V, T extends AbstractGuiDropdownMenu<V, T>> extends AbstractComposedGuiElement<T> implements IGuiDropdownMenu<V, T>, Clickable {
   ...
   protected ReadableDimension calcMinSize() {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         V value = var3[var5];
         int width = fontRenderer.width((String)this.toString.apply(value));
         if (width > maxWidth) {
            maxWidth = width;
         }
      }
   ...
   public void draw(GuiRenderer renderer, ReadableDimension size, RenderInfo renderInfo) {
      ...
      if (renderInfo.layer == 0) {
         ...
         var10002 = height / 2;
         Objects.requireNonNull(fontRenderer);
         renderer.drawString(3, var10002 - 9 / 2, ReadableColor.WHITE, (String)this.toString.apply(this.getSelectedValue()));
   ...
   public T setValues(V... values) {
      ...
      return (AbstractGuiDropdownMenu)this.getThis();
   }
   ...
   private class DropdownEntry extends AbstractGuiClickable<AbstractGuiDropdownMenu<V, T>.DropdownEntry> {
      ...
      public void draw(GuiRenderer renderer, ReadableDimension size, RenderInfo renderInfo) {
         ...
         renderer.drawString(3, 2, ReadableColor.WHITE, (String)AbstractGuiDropdownMenu.this.toString.apply(this.value));
      }
