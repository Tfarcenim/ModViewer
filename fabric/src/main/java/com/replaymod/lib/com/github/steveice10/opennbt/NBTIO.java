package com.replaymod.lib.com.github.steveice10.opennbt;
...
public class NBTIO {
   ...
   public static CompoundTag readTag(InputStream in, boolean littleEndian) throws IOException {
      return readTag((DataInput)((DataInput)(littleEndian ? new NBTIO.LittleEndianDataInputStream(in) : new DataInputStream(in))));
   }
   ...
   public static void writeTag(OutputStream out, CompoundTag tag, boolean littleEndian) throws IOException {
      writeTag((DataOutput)((DataOutput)(littleEndian ? new NBTIO.LittleEndianDataOutputStream(out) : new DataOutputStream(out))), tag);
   }
