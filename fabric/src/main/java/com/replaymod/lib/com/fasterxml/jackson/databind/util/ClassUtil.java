...
import com.replaymod.lib.com.fasterxml.jackson.databind.annotation.NoClass;
...
public final class ClassUtil {
   ...
   private static void _addSuperTypes(JavaType type, Class<?> endBefore, Collection<JavaType> result, boolean addClassItself) {
      if (type != null) {
         ...
         if (cls != endBefore && cls != Object.class) {
            ...
            Iterator var5 = type.getInterfaces().iterator();

            while(var5.hasNext()) {
               JavaType intCls = (JavaType)var5.next();
   ...
   private static void _addRawSuperTypes(Class<?> cls, Class<?> endBefore, Collection<Class<?>> result, boolean addClassItself) {
      if (cls != endBefore && cls != null && cls != Object.class) {
         ...
         Class[] var4 = _interfaces(cls);
         int var5 = var4.length;

         for(int var6 = 0; var6 < var5; ++var6) {
            Class<?> intCls = var4[var6];
   ...
   public static String exceptionMessage(Throwable t) {
      return t instanceof JsonProcessingException ? ((JsonProcessingException)t).getOriginalMessage() : t.getMessage();
   }
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if (field.isEnumConstant()) {
            ...
            if (defaultValueAnnotation != null) {
               ...
               Enum[] var9 = (Enum[])enumClass.getEnumConstants();
               int var10 = var9.length;

               for(int var11 = 0; var11 < var10; ++var11) {
                  Enum<?> enumValue = var9[var11];
