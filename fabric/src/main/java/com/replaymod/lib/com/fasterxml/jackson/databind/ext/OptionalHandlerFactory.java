...
public class OptionalHandlerFactory implements Serializable {
   ...
   private static final String SERIALIZERS_FOR_JAVAX_XML = "com.replaymod.lib.com.fasterxml.jackson.databind.ext.CoreXMLSerializers";
   private static final String DESERIALIZERS_FOR_JAVAX_XML = "com.replaymod.lib.com.fasterxml.jackson.databind.ext.CoreXMLDeserializers";
   private static final String SERIALIZER_FOR_DOM_NODE = "com.replaymod.lib.com.fasterxml.jackson.databind.ext.DOMSerializer";
   private static final String DESERIALIZER_FOR_DOM_DOCUMENT = "com.replaymod.lib.com.fasterxml.jackson.databind.ext.DOMDeserializer$DocumentDeserializer";
   private static final String DESERIALIZER_FOR_DOM_NODE = "com.replaymod.lib.com.fasterxml.jackson.databind.ext.DOMDeserializer$NodeDeserializer";
   ...
   public JsonSerializer<?> findSerializer(SerializationConfig config, JavaType type, BeanDescription beanDesc) {
      ...
      if (CLASS_DOM_NODE != null && CLASS_DOM_NODE.isAssignableFrom(rawType)) {
         return (JsonSerializer)this.instantiate("com.replaymod.lib.com.fasterxml.jackson.databind.ext.DOMSerializer");
      } else {
         String className = rawType.getName();
         if (!className.startsWith("javax.xml.") && !this.hasSuperClassStartingWith(rawType, "javax.xml.")) {
            return null;
         } else {
            String factoryName = "com.replaymod.lib.com.fasterxml.jackson.databind.ext.CoreXMLSerializers";
   ...
   public JsonDeserializer<?> findDeserializer(JavaType type, DeserializationConfig config, BeanDescription beanDesc) throws JsonMappingException {
      ...
      if (CLASS_DOM_NODE != null && CLASS_DOM_NODE.isAssignableFrom(rawType)) {
         return (JsonDeserializer)this.instantiate("com.replaymod.lib.com.fasterxml.jackson.databind.ext.DOMDeserializer$NodeDeserializer");
      } else if (CLASS_DOM_DOCUMENT != null && CLASS_DOM_DOCUMENT.isAssignableFrom(rawType)) {
         return (JsonDeserializer)this.instantiate("com.replaymod.lib.com.fasterxml.jackson.databind.ext.DOMDeserializer$DocumentDeserializer");
      } else {
         String className = rawType.getName();
         if (!className.startsWith("javax.xml.") && !this.hasSuperClassStartingWith(rawType, "javax.xml.")) {
            return null;
         } else {
            String factoryName = "com.replaymod.lib.com.fasterxml.jackson.databind.ext.CoreXMLDeserializers";
            Object ob = this.instantiate(factoryName);
