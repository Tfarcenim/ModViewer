...
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.BeanPropertyMap;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.ExternalTypeHandler;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.InnerClassProperty;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.ManagedReferenceProperty;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.MergingSettableBeanProperty;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.ObjectIdReader;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.ObjectIdReferenceProperty;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.ObjectIdValueProperty;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.PropertyBasedCreator;
...
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.TypeWrappedDeserializer;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.UnwrappedPropertyHandler;
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.ValueInjector;
...
import com.replaymod.lib.com.fasterxml.jackson.databind.exc.IgnoredPropertyException;
...
import com.replaymod.lib.com.fasterxml.jackson.databind.type.ClassKey;
...
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer, ValueInstantiator.Gettable, Serializable {
   ...
   public void resolve(DeserializationContext ctxt) throws JsonMappingException {
      ...
      if (this._valueInstantiator.canCreateFromObjectWith()) {
         ...
         if (this._ignorableProps != null) {
            ...
            for(int end = creatorProps.length; i < end; ++i) {
               ...
               if (this._ignorableProps.contains(origProp.getName())) {
      ...
      while(var13.hasNext()) {
         origProp = (SettableBeanProperty)var13.next();
      ...
      if (deser instanceof BeanDeserializerBase) {
         ...
         if (!vi.canCreateUsingDefault()) {
            ...
            if (enclosing != null && enclosing == this._beanType.getRawClass()) {
               Constructor[] var8 = valueClass.getConstructors();
               int var9 = var8.length;

               for(int var10 = 0; var10 < var9; ++var10) {
                  Constructor<?> ctor = var8[var10];
   ...
   public Collection<Object> getKnownPropertyNames() {
      ...
      while(var2.hasNext()) {
         SettableBeanProperty prop = (SettableBeanProperty)var2.next();
   ...
   protected void injectValues(DeserializationContext ctxt, Object bean) throws IOException {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ValueInjector injector = var3[var5];
