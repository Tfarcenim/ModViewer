...
public class BasicBeanDescription extends BeanDescription {
   ...
   public BeanPropertyDefinition findProperty(PropertyName name) {
      Iterator var2 = this._properties().iterator();
      ...
      do {
         ...
         prop = (BeanPropertyDefinition)var2.next();
   ...
   public Object instantiateBean(boolean fixAccess) {
      ...
      if (ac == null) {
         ...
         try {
            ...
            throw new IllegalArgumentException("Failed to instantiate bean of type " + this._classInfo.getAnnotated().getName() + ": (" + t.getClass().getName() + ") " + ClassUtil.exceptionMessage((Throwable)t), (Throwable)t);
         }
      }
   }
   ...
   public List<BeanPropertyDefinition> findBackReferences() {
      ...
      while(var3.hasNext()) {
         BeanPropertyDefinition property = (BeanPropertyDefinition)var3.next();
   ...
   public Map<String, AnnotatedMember> findBackReferenceProperties() {
      ...
      if (props == null) {
         ...
         while(var3.hasNext()) {
            BeanPropertyDefinition prop = (BeanPropertyDefinition)var3.next();
   ...
   public List<AnnotatedMethod> getFactoryMethods() {
      ...
      if (candidates.isEmpty()) {
         ...
         while(var3.hasNext()) {
            AnnotatedMethod am = (AnnotatedMethod)var3.next();
   ...
   public Constructor<?> findSingleArgConstructor(Class<?>... argTypes) {
      Iterator var2 = this._classInfo.getConstructors().iterator();
      ...
      while(true) {
         ...
         do {
            ...
            ac = (AnnotatedConstructor)var2.next();
         } while(ac.getParameterCount() != 1);

         Class<?> actArg = ac.getRawParameterType(0);
         Class[] var5 = argTypes;
         int var6 = argTypes.length;

         for(int var7 = 0; var7 < var6; ++var7) {
            Class<?> expArg = var5[var7];
            if (expArg == actArg) {
   ...
   public Method findFactoryMethod(Class<?>... expArgTypes) {
      Iterator var2 = this._classInfo.getFactoryMethods().iterator();
      ...
      while(true) {
         ...
         do {
            do {
               ...
               am = (AnnotatedMethod)var2.next();
            } while(!this.isFactoryMethod(am));
         } while(am.getParameterCount() != 1);

         Class<?> actualArgType = am.getRawParameterType(0);
         Class[] var5 = expArgTypes;
         int var6 = expArgTypes.length;

         for(int var7 = 0; var7 < var6; ++var7) {
            Class<?> expArgType = var5[var7];
   ...
   public LinkedHashMap<String, AnnotatedField> _findPropertyFields(Collection<String> ignoredProperties, boolean forSerialization) {
      ...
      Iterator var4 = this._properties().iterator();
      ...
      while(true) {
         ...
         do {
            ...
            do {
               ...
               property = (BeanPropertyDefinition)var4.next();
               f = property.getField();
            } while(f == null);
