...
import com.replaymod.lib.com.fasterxml.jackson.databind.ser.ResolvableSerializer;
import com.replaymod.lib.com.fasterxml.jackson.databind.ser.SerializerCache;
import com.replaymod.lib.com.fasterxml.jackson.databind.ser.SerializerFactory;
import com.replaymod.lib.com.fasterxml.jackson.databind.ser.impl.FailingSerializer;
import com.replaymod.lib.com.fasterxml.jackson.databind.ser.impl.ReadOnlyClassToSerializerMap;
import com.replaymod.lib.com.fasterxml.jackson.databind.ser.impl.TypeWrappedSerializer;
import com.replaymod.lib.com.fasterxml.jackson.databind.ser.impl.UnknownSerializer;
import com.replaymod.lib.com.fasterxml.jackson.databind.ser.impl.WritableObjectId;
import com.replaymod.lib.com.fasterxml.jackson.databind.ser.std.NullSerializer;
...
public abstract class SerializerProvider extends DatabindContext {
   ...
   protected JsonSerializer<Object> _createAndCacheUntypedSerializer(Class<?> rawType) throws JsonMappingException {
      ...
      try {
         ...
         ser = null;
         this.reportMappingProblem(var5, ClassUtil.exceptionMessage(var5));
      }
