...
final class AnnotatedCreatorCollector extends CollectorBase {
   ...
   private List<AnnotatedConstructor> _findPotentialConstructors(JavaType type, Class<?> primaryMixIn) {
      ...
      if (!type.isEnumType()) {
         ...
         ClassUtil.Ctor[] var6 = declaredCtors;
         i = declaredCtors.length;

         for(int var8 = 0; var8 < i; ++var8) {
            ClassUtil.Ctor ctor = var6[var8];
      ...
      if (primaryMixIn != null) {
         ...
         ClassUtil.Ctor[] var17 = ClassUtil.getConstructors(primaryMixIn);
         int var19 = var17.length;

         for(int var10 = 0; var10 < var19; ++var10) {
            ClassUtil.Ctor mixinCtor = var17[var10];
   ...
   private List<AnnotatedMethod> _findPotentialFactories(JavaType type, Class<?> primaryMixIn) {
      ...
      Method[] var4 = ClassUtil.getClassMethods(type.getRawClass());
      ...
      if (candidates == null) {
         ...
         if (primaryMixIn != null) {
            ...
            Method[] var16 = ClassUtil.getDeclaredMethods(primaryMixIn);
            int var8 = var16.length;

            for(int var9 = 0; var9 < var8; ++var9) {
               Method mixinFactory = var16[var9];
