...
public final class TypeFactory implements Serializable {
   ...
   private String _resolveTypePlaceholders(JavaType sourceType, JavaType actualType) throws IllegalArgumentException {
      ...
      for(int len = expectedTypes.size(); i < len; ++i) {
         ...
         if (!this._verifyAndResolvePlaceholders(exp, act) && !exp.hasRawClass(Object.class) && (i != 0 || !sourceType.hasRawClass(Map.class) || !act.hasRawClass(Object.class)) && (!exp.isInterface() || !exp.isTypeOrSuperTypeOf(act.getRawClass()))) {
