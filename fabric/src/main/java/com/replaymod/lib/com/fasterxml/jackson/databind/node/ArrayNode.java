...
import com.replaymod.lib.com.fasterxml.jackson.databind.util.RawValue;
...
public class ArrayNode extends ContainerNode<ArrayNode> {
   ...
   public ArrayNode deepCopy() {
      ...
      while(var2.hasNext()) {
         JsonNode element = (JsonNode)var2.next();
   ...
   public List<JsonNode> findValues(String fieldName, List<JsonNode> foundSoFar) {
      JsonNode node;
      for(Iterator var3 = this._children.iterator(); var3.hasNext(); foundSoFar = node.findValues(fieldName, foundSoFar)) {
         node = (JsonNode)var3.next();
      }
   ...
   public List<String> findValuesAsText(String fieldName, List<String> foundSoFar) {
      JsonNode node;
      for(Iterator var3 = this._children.iterator(); var3.hasNext(); foundSoFar = node.findValuesAsText(fieldName, foundSoFar)) {
         node = (JsonNode)var3.next();
      }
   ...
   public List<JsonNode> findParents(String fieldName, List<JsonNode> foundSoFar) {
      JsonNode node;
      for(Iterator var3 = this._children.iterator(); var3.hasNext(); foundSoFar = node.findParents(fieldName, foundSoFar)) {
         node = (JsonNode)var3.next();
      }
