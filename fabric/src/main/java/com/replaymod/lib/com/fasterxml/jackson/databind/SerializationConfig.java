...
import com.replaymod.lib.com.fasterxml.jackson.databind.cfg.MapperConfigBase;
...
public final class SerializationConfig extends MapperConfigBase<SerializationFeature, SerializationConfig> implements Serializable {
   ...
   public SerializationConfig with(SerializationFeature first, SerializationFeature... features) {
      ...
      SerializationFeature[] var4 = features;
      int var5 = features.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         SerializationFeature f = var4[var6];
   ...
   public SerializationConfig withFeatures(SerializationFeature... features) {
      ...
      SerializationFeature[] var3 = features;
      int var4 = features.length;

      for(int var5 = 0; var5 < var4; ++var5) {
         SerializationFeature f = var3[var5];
         newSerFeatures |= f.getMask();
      }
   ...
   public SerializationConfig withFeatures(JsonGenerator.Feature... features) {
      ...
      JsonGenerator.Feature[] var4 = features;
      int var5 = features.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         JsonGenerator.Feature f = var4[var6];
         int mask = f.getMask();
         newSet |= mask;
         newMask |= mask;
      }
   ...
   public SerializationConfig withFeatures(FormatFeature... features) {
      ...
      FormatFeature[] var4 = features;
      int var5 = features.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         FormatFeature f = var4[var6];
         int mask = f.getMask();
         newSet |= mask;
         newMask |= mask;
      }
