...
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.impl.BeanAsArrayDeserializer;
...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable {
   ...
   protected Object _deserializeUsingPropertyBased(JsonParser p, DeserializationContext ctxt) throws IOException {
      ...
      if (referrings != null) {
         Iterator var19 = referrings.iterator();

         while(var19.hasNext()) {
            BeanDeserializer.BeanReferring referring = (BeanDeserializer.BeanReferring)var19.next();
