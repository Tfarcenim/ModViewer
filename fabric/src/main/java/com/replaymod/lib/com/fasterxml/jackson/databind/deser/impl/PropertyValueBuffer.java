...
import com.replaymod.lib.com.fasterxml.jackson.databind.deser.SettableAnyProperty;
...
public class PropertyValueBuffer {
   ...
   public Object getParameter(SettableBeanProperty prop) throws JsonMappingException {
      ...
      return value == null && this._context.isEnabled(DeserializationFeature.FAIL_ON_NULL_CREATOR_PROPERTIES) ? this._context.reportInputMismatch((BeanProperty)prop, "Null value for creator property '%s' (index %d); `DeserializationFeature.FAIL_ON_NULL_FOR_CREATOR_PARAMETERS` enabled", prop.getName(), prop.getCreatorIndex()) : value;
   }
