...
public final class DeserializationConfig extends MapperConfigBase<DeserializationFeature, DeserializationConfig> implements Serializable {
   ...
   public DeserializationConfig with(DeserializationFeature first, DeserializationFeature... features) {
      ...
      DeserializationFeature[] var4 = features;
      int var5 = features.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         DeserializationFeature f = var4[var6];
   ...
   public DeserializationConfig withFeatures(DeserializationFeature... features) {
      ...
      DeserializationFeature[] var3 = features;
      int var4 = features.length;

      for(int var5 = 0; var5 < var4; ++var5) {
         DeserializationFeature f = var3[var5];
         newDeserFeatures |= f.getMask();
      }
   ...
   public DeserializationConfig withFeatures(JsonParser.Feature... features) {
      ...
      JsonParser.Feature[] var4 = features;
      int var5 = features.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         JsonParser.Feature f = var4[var6];
         int mask = f.getMask();
         newSet |= mask;
         newMask |= mask;
      }
