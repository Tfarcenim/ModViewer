...
public class BeanPropertyMap implements Iterable<SettableBeanProperty>, Serializable {
   ...
   private Map<String, String> _buildAliasMapping(Map<String, List<PropertyName>> defs) {
      if (defs != null && !defs.isEmpty()) {
         ...
         Iterator var3 = defs.entrySet().iterator();

         while(var3.hasNext()) {
            Entry<String, List<PropertyName>> entry = (Entry)var3.next();
            ...
            String mapped;
            for(Iterator var6 = ((List)entry.getValue()).iterator(); var6.hasNext(); aliases.put(mapped, key)) {
               PropertyName pn = (PropertyName)var6.next();
