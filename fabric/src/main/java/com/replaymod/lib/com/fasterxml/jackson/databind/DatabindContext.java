...
public abstract class DatabindContext {
   ...
   public JavaType resolveSubType(JavaType baseType, String subClass) throws JsonMappingException {
      if (subClass.indexOf(60) > 0) {
         JavaType t = this.getTypeFactory().constructFromCanonical(subClass);
         ...
         try {
            ...
            throw this.invalidTypeIdException(baseType, subClass, String.format("problem: (%s) %s", var6.getClass().getName(), ClassUtil.exceptionMessage(var6)));
         }
