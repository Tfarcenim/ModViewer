...
public class GuiEditReplay extends AbstractGuiPopup<GuiEditReplay> {
   ...
   protected GuiEditReplay(GuiContainer container, Path inputPath) throws IOException {
      ...
      try {
         ...
         GuiMarkerTimeline var10000 = (GuiMarkerTimeline)((GuiMarkerTimeline)((GuiMarkerTimeline)this.timeline.setSize(300, 20)).setMarkers()).setLength(replayFile.getMetaData().getDuration());
      ...
      })).addElements((LayoutData)null, new GuiElement[]{this.timelineTime, this.timeline, this.scrollbar, this.zoomButtonPanel});
      GuiButton buttonAddSplit = (GuiButton)((GuiButton)((GuiButton)((GuiButton)(new GuiButton()).setSize(100, 20)).setI18nLabel("replaymod.gui.edit.split", new Object[0])).setTooltip((new GuiTooltip()).setI18nText("replaymod.gui.edit.split.tooltip", new Object[0]))).onClick(() -> {
         Marker marker = new Marker();
         marker.setTime(this.timeline.getCursorPosition());
         marker.setName("_RM_SPLIT");
         this.timeline.addMarker(marker);
      });
      GuiButton buttonInsertCut = (GuiButton)((GuiButton)((GuiButton)((GuiButton)(new GuiButton()).setSize(100, 20)).setI18nLabel("replaymod.gui.edit.cut.start", new Object[0])).setTooltip((new GuiTooltip()).setI18nText("replaymod.gui.edit.cut.tooltip", new Object[0]))).onClick(() -> {
         Marker marker = new Marker();
         marker.setTime(this.timeline.getCursorPosition());
         marker.setName("_RM_START_CUT");
         this.timeline.addMarker(marker);
      });
      GuiButton buttonEndCut = (GuiButton)((GuiButton)((GuiButton)((GuiButton)(new GuiButton()).setSize(100, 20)).setI18nLabel("replaymod.gui.edit.cut.end", new Object[0])).setTooltip((new GuiTooltip()).setI18nText("replaymod.gui.edit.cut.tooltip", new Object[0]))).onClick(() -> {
         Marker marker = new Marker();
         marker.setTime(this.timeline.getCursorPosition());
         marker.setName("_RM_END_CUT");
         this.timeline.addMarker(marker);
      });
      GuiPanel controlPanel = (GuiPanel)((GuiPanel)(new GuiPanel()).setLayout((new HorizontalLayout()).setSpacing(4))).addElements((LayoutData)null, new GuiElement[]{buttonAddSplit, buttonInsertCut, buttonEndCut});
      ...
      GuiButton closeButton = (GuiButton)((GuiButton)((GuiButton)(new GuiButton()).setI18nLabel("replaymod.gui.close", new Object[0])).setSize(150, 20)).onClick(() -> {
         this.close();
      });
      GuiPanel buttonPanel = (GuiPanel)((GuiPanel)(new GuiPanel()).setLayout((new HorizontalLayout()).setSpacing(8))).addElements((LayoutData)null, new GuiElement[]{applyButton, closeButton});
      this.popup.setLayout((new VerticalLayout(VerticalLayout.Alignment.TOP)).setSpacing(10));
      this.popup.addElements(new VerticalLayout.Data(0.5D), new GuiElement[]{timelinePanel, controlPanel, buttonPanel});
   }
   ...
   private class EditTimeline extends GuiMarkerTimeline {
      ...
      private void drawCutQuads(GuiRenderer renderer, ReadableDimension size) {
         boolean inCut = false;
         int startTime = 0;
         Iterator var5 = ((List)this.markers.stream().sorted(Comparator.comparing(Marker::getTime)).collect(Collectors.toList())).iterator();
