...
public class MCVer {
   ...
   public static Optional<AbstractWidget> findButton(Iterable<? extends GuiEventListener> buttonList, String text, int id) {
      ...
      while(var4.hasNext()) {
         GuiEventListener e = (GuiEventListener)var4.next();
   ...
   public static void emitLine(BufferBuilder buffer, com.replaymod.lib.de.johni0702.minecraft.gui.utils.lwjgl.vector.Vector3f p1, com.replaymod.lib.de.johni0702.minecraft.gui.utils.lwjgl.vector.Vector3f p2, int color) {
      ...
      int b = color >> 8 & 255;
      int a = color & 255;
      com.replaymod.lib.de.johni0702.minecraft.gui.utils.lwjgl.vector.Vector3f n = com.replaymod.lib.de.johni0702.minecraft.gui.utils.lwjgl.vector.Vector3f.sub(p2, p1, (com.replaymod.lib.de.johni0702.minecraft.gui.utils.lwjgl.vector.Vector3f)null);
